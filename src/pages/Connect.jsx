    ...
    const content = (
        <>
            ...
            <div className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center bg-[#121212] border border-white/[0.05] shadow-inner text-white group-hover:border-brand-500/40 transition-all duration-500 shrink-0">
                <Icon size={24} strokeWidth={1.5} className="relative z-10 group-hover:scale-110 group-hover:text-brand-500 transition-all duration-500" />
...
const Connect = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-start px-6 pt-16 pb-20 font-sans selection:bg-brand-500/30 overflow-x-hidden">
            ...
            <div className="relative z-10 w-full max-w-[370px] flex flex-col items-center">
                ...
                >
                    ...
                    <div className="text-center">
                        <h1 className="text-white text-[2.4rem] font-black tracking-tighter uppercase italic leading-none mb-3 drop-shadow-2xl">
                            Techno Vanam
                        </h1>
                ...
                <motion.div className="w-full flex flex-col gap-4" initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.1, delayChildren: 0.2 } } }}>
                    ...
                    <motion.div variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }}>
                        <ConnectItem icon={MessageCircle} label="WhatsApp" sublabel="Connect with us" onClick={() => setShowWhatsAppModal(true)} />
                    </motion.div>
