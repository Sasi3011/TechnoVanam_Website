                    ...
                    <div className="relative w-full aspect-[4/5] overflow-hidden rounded-tl-[40px] rounded-br-[40px]">
                      {member.img ? (
                        <img
                          src={member.img}
                          alt={member.name}
                          className={`w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 ${member.name === "Vasanth R" ? "object-top" : member.name === "Sasikiran TT" ? "object-bottom -translate-y-12" : "object-center"}`}
                        />
                      ) : (
